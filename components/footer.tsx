        ...
        <div className="max-w-295 mx-auto px-5 grid md:grid-cols-[1.3fr_.7fr] gap-14">
          <div>
            ...
            <div className="mt-7 text-white/80 leading-7">
              <p>Bole Road, World Class Quality Secretariat, Addis Ababa, Ethiopia</p>
              <p className="mt-2">+251 11 600 0000</p>
              <p className="mt-2">worldclassqualityaward@gmail.com</p>
            </div>
          </div>
          <div>
            ...
            <nav className="mt-5" aria-label="Footer navigation">
              <ul className="space-y-3 text-white/75">
                {["About the Award", "How the Award Works", "Award Categories", "Award Gallery"].map(
                  (item) => (
                    <li key={item}>
                      <Link href="#about" className="hover:text-[#f4df9c] transition-colors">
                        {item}
                      </Link>
                    </li>
                  )
